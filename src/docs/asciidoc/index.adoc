...
include::{snippets}/book-group-controller-slice-test/find-group_success/http-request.adoc[]
...
include::{snippets}/book-group-controller-slice-test/find-group_success/path-parameters.adoc[]

==== Response

include::{snippets}/book-group-controller-slice-test/find-group_success/http-response.adoc[]
...
include::{snippets}/book-group-comment-controller-test/create-book-group-comment_-should-return-created/http-request.adoc[]

==== Request Header

include::{snippets}/book-group-comment-controller-test/create-book-group-comment_-should-return-created/request-headers.adoc[]

==== Request Body

include::{snippets}/book-group-comment-controller-test/create-book-group-comment_-should-return-created/request-body.adoc[]
include::{snippets}/book-group-comment-controller-test/create-book-group-comment_-should-return-created/request-fields.adoc[]

==== Response

include::{snippets}/book-group-comment-controller-test/create-book-group-comment_-should-return-created/http-response.adoc[]
...
include::{snippets}/book-group-comment-controller-test/find-book-groups-comment_-should-return-ok/http-request.adoc[]

==== Request Header

include::{snippets}/book-group-comment-controller-test/find-book-groups-comment_-should-return-ok/request-headers.adoc[]

==== Request Param

include::{snippets}/book-group-comment-controller-test/find-book-groups-comment_-should-return-ok/request-parameters.adoc[]

==== Response

include::{snippets}/book-group-comment-controller-test/find-book-groups-comment_-should-return-ok/http-response.adoc[]

==== Response Body

include::{snippets}/book-group-comment-controller-test/find-book-groups-comment_-should-return-ok/response-body.adoc[]
include::{snippets}/book-group-comment-controller-test/find-book-groups-comment_-should-return-ok/response-fields.adoc[]
