...
(id, created_at, modified_at, book_id, end_date, has_join_passwd, introduce, is_public, join_passwd, join_question,
 max_member_count, owner_id, start_date, title)
values (1, now(), now(), 1, DATE_ADD(NOW(), INTERVAL 1 DAY), false, '책모임이에요', true, NULL, NULL, 5, 1,
        DATE_ADD(NOW(), INTERVAL 3 DAY), '책모임');

insert into group_comments
(id, created_at, modified_at, book_group_id, contents, parent_comment_id, user_id)
values (1, now(), now(), 1, '내용', NULL, 1)
