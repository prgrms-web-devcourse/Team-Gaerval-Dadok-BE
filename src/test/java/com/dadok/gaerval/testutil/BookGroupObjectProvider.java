...
public class BookGroupObjectProvider {
	...
	public static List<BookGroupResponse> mockBookGroupResponses() {
		return List.of(
			...
			new BookGroupResponse(
				997L, "모임997", "모임 997에용", LocalDate.now(), LocalDate.now(), 5, true, false,
				5L, 2L,
			...
			new BookGroupResponse(
				995L, "모임995", "모임 995에용", LocalDate.now(), LocalDate.now(), 5, true, true,
				5L, 0L,
			...
			,
			new BookGroupResponse(
				994L, "모임994", "모임 994에용", LocalDate.now(), LocalDate.now(), 5, false, true,
				3L, 30L,
			...
			,
			new BookGroupResponse(
				993L, "모임993", "모임 993에용", LocalDate.now(), LocalDate.now(), 5, false, false,
				4L, 4000L,
